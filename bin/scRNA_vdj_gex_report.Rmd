...
expl_tbl <- tribble(
    ~title, ~content,
    "Clones (Paired)",
    "Here we counted unique CDR3 amino acid pairs with identical germline VDJ gene segments as different clones. This result includes all the paired ones from the clonotype table.",
    "Lineage Number",
...
expl_tbl <- tribble(
    ~title, ~content,
    "Top 1000 Clonotypes",
    "Clonotypes are defined as the same VH and VL CDR3 amino acid sequences as well as identical VDJ combinations. Here we also require the chains to be productive, and cells with only one chain detected are also included."
)
