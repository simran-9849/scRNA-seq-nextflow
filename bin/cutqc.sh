...
Added path/to/Rmd as the fourth option to adapt the script to nextflow pipeline
"
...
Rscript -e 'rmarkdown::render("'$cutqcRmd'", params=list(read1_before_dir = "'$read1_before_dir'", read1_after_dir="'$read1_after_dir'", read2_before_dir = "'$read2_before_dir'", read2_after_dir = "'$read2_after_dir'"), intermediates_dir=getwd(), knit_root_dir=getwd(), output_dir = getwd(), output_file="'$outHtml'")'
